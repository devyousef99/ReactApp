                ...
                <div className="col-xl-10 col-lg-12 col-md-9">
                    <div className="card o-hidden border-0 shadow-lg my-5">
                        <div className="card-body p-0">
                            <div className="row" style={{alignItems:'center', paddingLeft:50}}>
                                <div className="col-lg-6 d-none d-lg-block bg-login-image" style={{width:50, height:150}}></div>
                                <div className="col-lg-6">
                                    <div className="p-5">
                                        ...
                                        <div className="copyright text-center my-auto">
                                            <span>Copyright &copy; NAPCO National 2022</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
